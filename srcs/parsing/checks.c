...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/16 04:04:54 by adiehl-b          #+#    #+#             */
/*   Updated: 2025/04/16 04:04:55 by adiehl-b         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// si map pas complètement entoure de murs -> obligatoire "Error",
// avec un autre msg[ok]
// si ya des lignes vides -> obligatoire "Error", avec un autre msg[ok]
// si ya des caracteres autres que 1, 0, N, S, E, W
// -> obligatoire "Error",avec un autre msg[ok]
...
// si la map pas en derniere position
// -> obligatoire "Error",avec un autre msg[ko]
// si player sur ligne de bordure -> obligatoire "Error",avec un autre msg[ok]
// si pas le bon extension ou mauvais extension
// -> obligatoire "Error",avec un autre msg[ok]
// si la map est bien entoure de murs ,
// 	et que ya des '1' et '0' en dehors-> c'est bon[ok]
// // si map en derniere position et que ya espace vide apres -> c'est bon ,
// 	mais on considere c pas bon[ok]
