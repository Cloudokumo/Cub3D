...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/07 13:23:48 by carzhang          #+#    #+#             */
/*   Updated: 2024/10/16 10:08:31 by carzhang         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			fill_main_image_with_differents_tiles(t_imgs *img_dst,
					t_mlix *mlx);
void			copy_pixels_to_mlx_image(t_mlix *mlx, t_imgs *img_src,
					int x_start, int y_start);
void			my_mlx_pixel_put(t_imgs *img, int x, int y, int color);

// file of move_of_player.c
